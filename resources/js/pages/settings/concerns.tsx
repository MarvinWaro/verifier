...
export default function ConcernsIndex({ concerns, filters }: Props) {
    ...
    return (
        <AppLayout>
        <SettingsLayout>
            <Head title="Concerns - Settings" />

            <div className="space-y-6">
                <div>
                    <h3 className="text-lg font-medium">Concerns & Issues</h3>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            View and manage reported issues and concerns
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {/* Search Bar */}
                        ...
                        <div className="rounded-md border overflow-x-auto">
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        <TableHead className="min-w-[160px]">School / HEI</TableHead>
                                        <TableHead className="min-w-[140px]">Program</TableHead>
                                        <TableHead className="min-w-[200px]">Concern Details</TableHead>
