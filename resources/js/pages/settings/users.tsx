...
export default function UsersIndex({ users, roles, filters }: Props) {
    ...
    const handleEdit = (user: User) => {
        setEditingUser(user);
        // Find the role_id from the user's role name if role_id is not set
        const roleId = user.role_id || roles.find(r => r.name === user.role)?.id || roles[0]?.id || 0;
        editForm.setData({
            name: user.name,
            email: user.email,
            password: '',
                                    ...
                                    <div className="space-y-4 py-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Select
                                                ...
                                                onValueChange={(value) =>
                                                    createForm.setData('role_id', parseInt(value))
                                                }
                                            >
                                                <SelectTrigger>
                        ...
                        <div className="space-y-4 py-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) =>
                                        editForm.setData('role_id', parseInt(value))
                                    }
                                >
                                    <SelectTrigger>
                                        <SelectValue placeholder="Select role" />
