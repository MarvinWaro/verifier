                                ...
                                <Popup>
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-gray-600">
                                            Code: <span className="font-mono">{hei.instCode}</span>
                                        </p>
                                        ...
                                        {hei.ownershipSector && (
                                            <p className="text-xs text-gray-600">
                                                ...
                                                {hei.ownershipHei_type ? ` (${hei.ownershipHei_type})` : ''}
                                            </p>
                                        )}
                        ...
                        <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-3 text-center">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="max-w-xs text-xs text-gray-600 dark:text-gray-400">
                                    No HEI coordinates available yet. Once the API returns locations,
